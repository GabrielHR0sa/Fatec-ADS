...
CREATE TABLE FUNCIONARIO(
    ...
    CONSTRAINT UQ_FUNCIONARIO_EMAIO UNIQUE(EMAIL),
...
CREATE TABLE PROJETO(
    ...
    CONSTRAINT FK_PROJETO_FUNCIONARIO FOREIGN KEY(COD_FUNC_GER)
        REFERENCES FUNCIONARIO(CODIGO),
    CONSTRAINT CK_PROJETO CHECK(DATA_TERMINO IS NULL OR DATA_TERMINO>=DATA_INICIO)  
);
GO
CREATE TABLE FUNCIONARIO_PROJETO(
    ...
    CONSTRAINT CK_FUNCIONARIO_DATA_SAIDA 
        CHECK(DATA_SAIDA IS NULL OR DATA_SAIDA>=DATA_ENTRADA),    
    CONSTRAINT CK_FUNCIONARIO_PROJETO CHECK(NUM_HORAS_TRAB>=0)
);
